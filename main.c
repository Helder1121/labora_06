...
int main(void)
{
    ...
    tiempo = SysCtlClockGet() / 3 ;//funcion para determinar el segundo
    while(1){
        //lee siempre 1 si es 0 entra al if y pasa el while hasta que deje de
        //presioanr ejecuta la secuencia de lo contrario no hace nada
        ...
        SysCtlDelay (tiempo) ;//la funcion de SysCtlDelay lo mide en nanosegundos
